...
#| fig-width: 10
#| fig-height: 6
#| fig-cap: "Adjacency matrix of the bipartite genes - cell graph. Rows: cells, columns: genes. Blue: inside the neighbourhood (there is an edge), yellow: outside (no edge)."
library("pheatmap")
pheatmap(adj[sample(nrow(adj), 2500), ] + 0, 
  color = c("#FFD700", "#0057B7"),
  show_rownames = FALSE, show_colnames = FALSE, treeheight_row = 0, treeheight_col = 0, legend = FALSE)
```
