...
We now have a list of `{r}length(master_result$genes)` genes showing significant differential expression within a neighborhood of `{r}length(master_result$neighborhood)` cells. To visualise the result, we can colour all cells belonging to the master neighborhood as shown in @fig-master-neighborhood.
