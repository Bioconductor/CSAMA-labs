...
Here, we use _latent embedding multivariate regression_ (LEMUR) (@AhlmannEltze:NatGen:2025), a model that operates without or before commitment to discrete categorization. 
...
# Appendix: A prelude on data integration
