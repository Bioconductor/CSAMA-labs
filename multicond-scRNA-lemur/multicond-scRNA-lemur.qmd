...
pheatmap(adj_jn[sample(nrow(adj_jn), 2048), ], show_rownames = FALSE, show_colnames = FALSE, , treeheight_row = 0, treeheight_col = 0)
```
:::
...
#| echo: true
#| eval: true
#| fig-cap: "Distribution of NMF coefficients"
j = 1
