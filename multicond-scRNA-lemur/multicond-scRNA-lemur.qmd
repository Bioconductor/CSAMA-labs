...
#| fig-height: 7
#| out-width: "75%"
#| fig-cap: "Adjacency matrix of the bipartite graph of genes and cells. Rows: cells, columns: genes. Blue: inside the neighbourhood, LFC<0; red: inside the neighbourhood, LFC>0; light grey: outside (no edge)."
library("pheatmap")
