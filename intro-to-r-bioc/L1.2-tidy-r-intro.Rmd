...
Presenting Author: [Maria Doyle][]</br >
Date: 23-28 June, 2024</br >
Back: [Monday labs](lab-1-intro-to-r-bioc.html)

[Maria Doyle]: mailto: maria.doyle@ul.ie
...
For a tidy interface to some Bioconductor classes, see the tidyomics [package](https://bioconductor.org/packages/tidyomics/) and [paper](https://www.nature.com/articles/s41592-024-02299-2).
